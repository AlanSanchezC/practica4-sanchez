...
$url="https://practica4-sanchez.000webhostapp.com/";
...
defined('DATABASE_NAME') ? NULL : define('DATABASE_NAME', 'id7754007_myinfo');
defined('DATABASE_USER') ? NULL : define('DATABASE_USER', 'id7754007_root');
defined('DATABASE_PASSWORD') ? NULL : define('DATABASE_PASSWORD', 'practica4');
